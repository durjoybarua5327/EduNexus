        ...
        <div className="p-6 space-y-6 animate-in fade-in duration-500 max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-6 bg-gradient-to-r from-white to-indigo-50/50 p-6 rounded-3xl border border-white/50 shadow-sm backdrop-blur-sm relative overflow-hidden">
                <div className="flex items-center gap-4 relative z-10">
                    <div className="p-3 bg-gradient-to-br from-indigo-500 to-violet-500 rounded-2xl shadow-lg shadow-indigo-200 text-white">
                        <BookOpen className="w-8 h-8" />
                    </div>
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Course Management</h1>
                        <p className="text-gray-500 font-medium mt-1">Organize courses by semester and assign instructors.</p>
                    </div>
                </div>
                <div className="flex gap-3 relative z-10">
                    <button
                        onClick={() => setIsSemesterModalOpen(true)}
                        className="flex items-center gap-2 px-5 py-3 bg-white border border-indigo-100 text-indigo-700 rounded-xl hover:bg-indigo-50 transition-all shadow-sm hover:shadow-md font-semibold"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 active:scale-95 font-semibold disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    >
                        ...
                        {selectedSemester ? (
                            <>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {courses.map(course => (
                                        <div key={course.id} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-transform transition-shadow duration-300 will-change-transform group">
